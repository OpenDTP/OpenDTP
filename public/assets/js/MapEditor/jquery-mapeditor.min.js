...
MAPEDITOR.plugins.push(function(){var a,e="flatplan";this.load=function(e){a=$('<div class="flatplan"></div>'),this.loadFlatplan(e),e.right_pannel.append(a)},this.loadFlatplan=function(a){for(var e,t,n,p,s=a.map.spreads.length,r=0;s>r;r++){p=a.map.spreads[r].pages.length,t=$('<div class="spread" data-index="'+r+'"></div>'),n=1/a.map.spreads[r].nb_pages*100;for(var d in a.map.spreads[r].pages)e=$('<div class="page"><img class="page" src="'+a.map.spreads[r].pages[d].preview+'" width="100%" /></div>'),e.css("width",n.toFixed(2)+"%"),t.append(e);t.click(a,function(a){a.data.properties.current_spread=parseInt($(a.target).parents(".spread").attr("data-index")),a.data.renderer.render(a.data.properties.current_spread,!0)}),this.flatplan.append(t)}},this.__defineGetter__("name",function(){return e}),this.__defineGetter__("flatplan",function(){return a}),this.__defineSetter__("name",function(a){e=a})});
